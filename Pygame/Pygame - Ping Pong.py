...
ballDirX = random.choice([-2,-1,1,2])
ballDirY = random.choice([-2,-1,0,1,2])
...
class game:
  ...
  def over():
    ...
    if ballX <= 5:
      ...
      game.winner = ["Player 2 wins!", RED]
    
    elif ballX >= 495:

      game.running = False

      game.winner = ["Player 1 wins!", BLUE]
...
showMessage(game.winner[0], game.winner[1], 5)
